				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form name="frmeditmember" class="form-horizontal" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label for="">ADDRESS</label>
								<textarea type="text" class="form-control" id="address" placeholder="Input address" name="address" value="@{{address}}" ng-model="member.address" ng-maxlength="300"  ng-required="true"></textarea>
